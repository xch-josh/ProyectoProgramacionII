    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (txtCode.getText().trim().length() != 0 && txtName.getText().trim().length() != 0 && txtPrice.getText().trim().length() != 0 && txtQuantity.getText().trim().length() != 0) {
            try {
                ...
                model = new ProductAddModel(txtCode.getText().trim(), txtName.getText().trim(), Double.parseDouble(txtPrice.getText().trim()), Integer.parseInt(txtQuantity.getText().trim()), txtExpireDate.getDate());
                else
                model = new ProductAddModel(txtCode.getText().trim(), txtName.getText().trim(), Double.parseDouble(txtPrice.getText().trim()), Integer.parseInt(txtQuantity.getText().trim()), null);
